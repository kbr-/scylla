...
public:
    ...
    class value : public multi_item_terminal, collection_terminal {
        static shared_ptr<value> from_serialized(bytes_view v, list_type type, cql_serialization_format sf);
    public:
    ...
    public:
        ...
        static shared_ptr<value> from_serialized(const fragmented_temporary_buffer::view& v, list_type type, cql_serialization_format sf);
