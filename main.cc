    ...
    return app.run(ac, av, [&] () -> future<int> {
        ...
        return seastar::async([cfg, ext, &db, &qp, &proxy, &mm, &mm_notifier, &ctx, &opts, &dirs,
          ...
          try {
            ...
            service::init_storage_service(stop_signal.as_sharded_abort_source(), db, gossiper, auth_service, sys_dist_ks, view_update_generator, feature_service, cdc_gen_service, sscfg, mm_notifier, token_metadata, cdc_gen_service).get();
