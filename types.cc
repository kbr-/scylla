...
static bytes serialize_for_native_protocol_aux(const map_type_impl&, collection_mutation_view_description mut, cql_serialization_format sf) {
...
static bytes serialize_for_native_protocol_aux(const set_type_impl&, collection_mutation_view_description mut, cql_serialization_format sf) {
    std::vector<bytes_view> tmp;
...
static bytes serialize_for_native_protocol_aux(const list_type_impl&, collection_mutation_view_description mut, cql_serialization_format sf) {
    std::vector<bytes> linearized;
    std::vector<bytes_view> tmp;
    tmp.reserve(mut.cells.size());
    for (auto&& e : mut.cells) {
